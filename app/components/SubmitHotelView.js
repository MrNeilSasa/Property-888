  ...
  const handleUpload = async (e) => {
    ...
    try {
      ...
      if (!price || price.trim() === '') {
        ...
        errors.push('Error in Price - must be a number with at most 2 decimal places')
      }
      ...
      const response = axios.post(
        'https://www.property888.xyz/api/uploadHotel',
      ...
      <form encType="multipart/form-data" method="post">
        ...
        <div className="mb-3">
          ...
          >
            ...
            <input type="file" required {...getImageInputProps({ name: 'images' })} />
