...
import './Team.css'
import antonioImg from '/public/images/Antonio-Profile-Pic.jpeg'
import rodgerImg from '/public/images/Rodger-Profile-Pic.jpeg'
import advisor1 from  '/public/images/Claus-Profile-Pic.jpeg'
    ...
    <div>
        <div className="team-page">
            ...
            <div className="team-members">
                ...
                <TeamMember key={member.name} {...member} /> // Pass props using spread operator
                ))}
            </div>
            <h1> Advisor</h1>
            <div className="advisors">
                {advisors.map((advisor) => (
                <TeamMember key={advisor.name} {...advisor} /> // Pass props using spread operator
                ))}
            </div>
        </div>
